        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div className="relative mt-8 lg:mt-0">
            <div className="relative z-10 grid grid-cols-1 gap-8">
              {/* Author Photo */}
              <div className="card-primary bg-background/80 backdrop-blur-sm relative z-20">
              ...
              {/* Book Preview */}
              <a href="/#books">
                <div className="card-primary bg-background/80 backdrop-blur-sm cursor-pointer hover:scale-105 transition-transform relative z-20">
                  <div className="flex items-center gap-4">
                    <div className="w-16 h-16 rounded-lg overflow-hidden bg-muted">
                      <img 
                        src={billyBearAlt} 
                        alt="Billy Bear's Brown Hair" 
                        className="w-full h-full object-contain"
                      />
                    </div>
                    <div>
                      <p className="text-sm text-muted-foreground">Latest Book</p>
                      <h4 className="font-semibold text-foreground">Billy Bear's Brown Hair</h4>
            ...
            <div className="absolute inset-0 -z-10 pointer-events-none">
              <div className="absolute top-8 right-8 w-24 h-24 bg-primary/5 rounded-full blur-3xl"></div>
              <div className="absolute bottom-12 left-12 w-20 h-20 bg-accent/5 rounded-full blur-3xl"></div>
              <div className="absolute top-1/2 right-12 w-12 h-12 bg-secondary/5 rounded-full blur-2xl"></div>
            </div>
          </div>
        </div>
      </div>
