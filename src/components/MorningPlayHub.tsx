      ...
      <div className="container-width section-padding">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16">
          ...
          <div className="bg-background/80 p-8 rounded-2xl border border-border">
            <h3 className="text-xl font-bold text-foreground mb-6">Session Benefits</h3>
            <ul className="space-y-3 mb-6">
              ...
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-secondary rounded-full mt-2"></div>
                <span className="text-muted-foreground">Take-home extension activities</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-secondary rounded-full mt-2"></div>
              ...
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-secondary rounded-full mt-2"></div>
                <span className="text-muted-foreground">Small group sizes for focused learning</span>
              </li>
            </ul>
